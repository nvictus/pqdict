...
# The theme to use for HML and HTML Help pages.  See the documentation for
...
latex_documents = [
    (master_doc, "pqdict.tex", "pqdict Documentation", "Nezar Abdennur", "manual"),
]
...
man_pages = [(master_doc, "pqdict", "pqdict Documentation", [author], 1)]
